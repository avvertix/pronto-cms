...
if (! function_exists('content_path')) {
    ...
    {
        return realpath(config('pronto.content_folder').($path ? '/'.$path : $path));
    }
}
...
if (! function_exists('image_path')) {
    ...
    {
        return realpath(config('pronto.image_folder').($path ? '/'.$path : $path));
    }
}
...
if (! function_exists('assets_path')) {
    ...
    {
        return realpath(config('pronto.assets_folder').($path ? '/'.$path : $path));
    }
}
